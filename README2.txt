...
Agora, para configurar a ligação entre dois contêineres, node-app e redis , use o Docker Compose. Crie o arquivo docker-compose.yml e declare a versão a ser usada, os serviços usados, como construir a imagem e especificar a porta na máquina local e no contêiner também.

Use o seguinte comando para iniciar o arquivo docker-compose, que configura tudo. Comando:docker-compose up

*Para reconstruir as imagens específicas dentro do docker-compose Comando:docker-compose up --build
